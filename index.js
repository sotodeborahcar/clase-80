...
fetch(
  ...
  .then((data) => {
    ...
    const comics = data.data.results; // dentro del archivo denominado "data" tengo la propiedad "data" y dentro el array "results"
    ...
    comicsHTML.forEach((comic) => {
      comic.onclick = () => {
        // console.log('me hiciste click a un click')
        console.log(comic.dataset.id);
        // console.log(comic); ==> me da un parrafo con la data que necesito
        // conseguirDataComic();
